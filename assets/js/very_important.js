...
detectedAdblock().then(result => {
    if (!result) {
        document.getElementById('blurb').innerText = document.getElementById('blurb').innerText + "\nFor your own sanity, please use an adblocker. Or it's free shekels for me.";
        alert("Please use an adblocker.");
    }
});